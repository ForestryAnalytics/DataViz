...
autoplot(object, xvar = c("norm", "lambda", "dev"),
...
xvar values to be dranw on the X axis. Either "norm" (L1-norm), "lambda" (log-
lambda sequence) or "dev" (percent deviance)
...
autoplot(glmnet::glmnet(data.matrix(Orange[-3]), data.matrix(Orange[3])))autoplot.kmeans
17
autoplot.kmeans
