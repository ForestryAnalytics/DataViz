...
original Combined to data by column if provided. Intended to be used for stat functions
which returns not containing original data.
...
label.vjust Vertical adjustment for text labels22
autoplot.MSM.lm
