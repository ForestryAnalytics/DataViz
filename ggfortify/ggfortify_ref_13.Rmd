...
ggdistribution(pchisq, 0:20, p = p, df = 9, fill = 'red')ggfortify
ggfortify
65
ggfortify
...
Slots
plots List of ggplot2::ggplot instances
...
ggfortify:::plot_confint(p, data = d)plot_label
plot_label
71
...
#### Usage 
 <pre><code>
plot_label(p, data, x = NULL, y = NULL, label = TRUE,
label.label = "rownames", label.colour = NULL, label.alpha = NULL,
...
label.repel
Logical flag indicating whether to use ggrepel, enabling this may take some
time for plotting
label.show.legend
