...
series).
Details
Run methods(hchart) to see what objects are supported.16
hchart.survfit
hchart.survfit
...
hcmap
Shorcut for create map Shorcut for create map from https://code.
highcharts.com/mapdata/ collection.
...
download_map_data
A logical value whether to download (add as a depedeny) the map. Default
FALSE.
