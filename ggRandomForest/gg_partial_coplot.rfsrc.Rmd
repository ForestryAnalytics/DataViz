---
title: "gg_partial_coplot.rfsrc Data structures for strati???ed partial coplots"
...
gg_partial_coplot.rfsrc Data structures for strati???ed partial coplots
Description Data structures for strati???ed partial coplots
Usage
<pre><code>
## S3 method for class 'rfsrc' gg_partial_coplot(object, xvar, groups, surv_type = c("mort", "rel.freq", "surv", "years.lost", "cif", "chf"), time, ...)
</code></pre>
...
```{r}
# Load the forest data(pbc, package = "randomForestSRC")
rfsrc_pbc
